...
import type { ProviderAuthState }               from "../src/core/ports/integration/auth-controller-port";
...
import type { ModelPickerOptions }              from "../src/adapters/inbound/tui/features/model-selection/view/model-picker-overlay";
