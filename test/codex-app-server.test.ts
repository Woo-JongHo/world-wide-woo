...
import type { JsonLineTransport } from "../src/system/adapters/executors/codex-app-server.js";
import { CodexAppServer, NativeOperationUncertainError, StdioJsonLineTransport } from "../src/system/adapters/executors/codex-app-server.js";
		...
		expect(transport.sent.slice(0, 2)).toEqual([
			{
				...
				method: "initialize",
				params: {
					clientInfo: { name: "www", title: "World Wide Woo", version: "0.0.15" },
