...
- 공통 monitoringTable에 heading·minWidth·weight·align 기반 열 분배와 ANSI 표시 폭 정렬을 추가하고 Context composition을 SOURCE·DISTRIBUTION·SIZE·SHARE 축으로 전환했다.
...
- 공통 monitoring layout·Context fidelity 13 pass / 0 fail, architecture 포함 관련 테스트 26 pass / 0 fail.
