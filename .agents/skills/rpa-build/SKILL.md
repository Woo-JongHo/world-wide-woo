...
3. 한 Unit의 입력·출력·부작용·재실행 계약을 구현하고 그 계약을 관측하는 테스트와 안전 로그를 함께 작성한다.
   구현 뒤 [RPA Description 계약 v1](../../../docs/workflows/RPA_DESCRIPTION_CONTRACT.md)의 Unit 기술·코드 설명·Step 연결과 영향 예외·테스트를 실제 코드에 맞춰 갱신한다. 책임이 같으면 ID를 유지하고, 개수는 공통 엔진이 계산한다.
