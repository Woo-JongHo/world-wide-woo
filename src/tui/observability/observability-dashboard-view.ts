...
import type { ObservabilityDashboard, ObservabilitySessionSummary } from "../../system/public.js";
import { dashboardSessionWindow } from "../layout/dashboard-session-window.js";
