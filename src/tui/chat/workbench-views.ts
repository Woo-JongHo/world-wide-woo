...
import type { NativeApprovalRequest } from "../../system/public";
import type { CompletionReport } from "../../system/public";
import { projectBackgroundWorkState, type BackgroundWorkState } from "../../system/public";
import { sanitizeCompletedAssistantResponse, sanitizePartialAssistantResponse } from "../../system/public";
import { sanitizeTerminalTextExcerpt, sanitizeTerminalTextUnbounded } from "../../system/public";
import { projectTNoteCompletionIndex } from "../../system/public";
import { workbenchApprovalDecisions, type WorkbenchSnapshot } from "../../system/public";
import { classifyWorkActivity, type SemanticWorkStep, type WorkStepStatus } from "../../system/public";
import { boundedPublicProjection, PUBLIC_SOURCE_OMISSION } from "./bounded-public-projection";
import { colors, markdownTheme, semantic } from "../theme/theme";
import { WorkbenchWelcomeView } from "../shell/workbench-welcome";
import { isVisibleWorkStep, ObservationCard, WorkStepCard } from "../work/work-step-card";
import { projectWorkbenchDelegationSections } from "../work/delegation-tree-view";
