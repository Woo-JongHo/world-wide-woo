import { executeDevelopmentShellCommand } from "../../workflows/tui-development/index";
import {
...
import type { AuthController, ComposerDraftController, ObservabilityHistoryReader, UsageMonitor, WorkbenchGitTelemetryReader } from "../../system/public";
import type { DevelopmentSession, ProjectWorkbenchController } from "../../system/public";
import { EMPTY_DEVELOPMENT_MAP, type DevelopmentMapSnapshot } from "../../system/public";
import { projectObservabilityDashboard, summarizeObservabilityStreams, type ObservabilityDashboard } from "../../system/public";
import { projectRuntimeMonitor, type RuntimeMonitorProjection } from "../../system/public";
import { normalizeSettings, type WwwSettings } from "../../system/public";
import { projectSessionStats } from "../../system/public";
import { sanitizeTerminalTextUnbounded } from "../../system/public";
import { workbenchApprovalIdentity, type WorkbenchCommandReceipt, type WorkbenchSnapshot } from "../../system/public";
import { createDashboardLayout } from "../layout/dashboard-layout";
import { StatusLine, WorkspaceTodoView } from "../workbench/shared-dashboard-views";
...
import { OverlaySheet } from "../layout/overlay-sheet";
...
import { colors, editorTheme } from "../theme/theme";
...
import { UsageStripView } from "../workbench/usage-strip-view";
import { DevelopmentMapView } from "../observability/development-map-view";
import { ObservabilityDashboardView } from "../observability/observability-dashboard-view";
import { RuntimeMonitorView } from "../observability/runtime-monitor-view";
import { SessionStatsView } from "../observability/session-stats-view";

export interface ProjectWorkbenchShellDependencies {
	workbench: ProjectWorkbenchController;
	development?: Pick<DevelopmentSession, "execute">;
	cwd?: string;
	usage: UsageMonitor;
	auth: AuthController;
...
export function runProjectWorkbenchShell(dependencies: ProjectWorkbenchShellDependencies): void {
	...
	const showReceipt = (receipt: Awaited<ReturnType<ProjectWorkbenchController["dispatch"]>>) => {
