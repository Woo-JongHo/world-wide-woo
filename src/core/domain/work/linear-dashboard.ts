...
export interface LinearProjectDashboard {
	...
	readonly comments: readonly LinearDashboardComment[];
...
export const EMPTY_LINEAR_PROJECT_DASHBOARD: LinearProjectDashboard = Object.freeze({
	state: "unavailable", projectName: "Linear 프로젝트", fetchedAt: null, issues: Object.freeze([]), update: null, comments: Object.freeze([]), milestones: Object.freeze([]), error: "Linear Dashboard가 연결되지 않았습니다.",
});
