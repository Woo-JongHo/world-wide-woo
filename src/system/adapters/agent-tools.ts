...
import type { AgentTool, AgentToolExecution, TodoController } from "../contracts/ports";
import type { CommandResultSnapshot, GenericToolResultSnapshot } from "../contracts/output";
