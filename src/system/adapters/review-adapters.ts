...
import { redactForExternalReview } from "../contracts/redaction";
import type { SessionModelUsageObservation } from "../services/session-model-usage.js";
...
export class PiReviewGenerationClient implements ReviewGenerationClient {
	...
	async generate(request: import("../contracts/review").ReviewGenerationRequest): Promise<string> {
...
function assertDetachedRequest(request: import("../contracts/review").ReviewGenerationRequest): void {
