...
import { a, fit, mark, oneLine, prose, safe, section }  from "@/adapters/inbound/tui/foundation/theme/www-theme";
...
export function renderWwwTestView(workspace: RequestTestWorkspace, width: number): string[] {
	const rows = [
...
export class WwwTestView implements Component {
	...
	render(width: number): string[] {
		return renderWwwTestView(this.getProjection(), width);
	}
}
