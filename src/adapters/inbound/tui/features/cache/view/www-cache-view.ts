...
import { a, fit, number, pair, prose, railSection, section } from "@/adapters/inbound/tui/foundation/theme/www-theme";
import {
	syntheticCacheRailRows,
	syntheticCacheRows,
} from "@/adapters/inbound/tui/features/cache/view/www-cache-catalog";
...
export class WwwCacheView implements Component {
...
export class WwwCacheRail implements Component {
	constructor(private readonly get: () => CacheTelemetrySnapshot, private readonly isDemo: () => boolean = () => false) {}
	invalidate(): void {}
	render(width: number): string[] {
