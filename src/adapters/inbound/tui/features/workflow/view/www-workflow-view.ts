...
import { workflowDemoRail, workflowDemoRows }                   from "@/adapters/inbound/tui/features/workflow/view/www-workflow-catalog";
...
export class WwwWorkflowView implements Component {
...
export class WwwWorkflowRail implements Component {
	constructor(private readonly get: () => WorkbenchSnapshot, private readonly isDemo: () => boolean = () => false) {}
	invalidate(): void {}
	render(width: number): string[] {
