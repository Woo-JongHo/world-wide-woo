...
| --- | --- | --- | --- | --- |
| [ST-011-06](../.www/planning/artifacts/ST-011-06.md) | App Server native vertical slice | `src/adapters/outbound/execution/codex-app-server.ts`, `src/core/ports/execution/executor-port.ts` | lifecycle probe | PASS: adapter + 실제 approval/cancel/resume probe |
| [ST-011-07](../.www/planning/artifacts/ST-011-07.md) | append-only `ProjectActivity` | `src/core/domain/execution/project-activity.ts`, `src/adapters/outbound/persistence/activity-journal-store.ts` | ST-011-06 | PASS: append/replay/corruption/sequence test |
| [ST-011-08](../.www/planning/artifacts/ST-011-08.md) | Chat·T-notes·Todo 3-pane Workbench | `src/core/application/orchestration/project-workbench.ts`, `src/adapters/inbound/tui/` | ST-011-06, ST-011-07 | PASS: contract/layout + 실제 PTY stream/resume |
| [ST-011-09](../.www/planning/artifacts/ST-011-09.md) | source-linked packet-only T-note draft | `src/core/application/work/t-note-service.ts`, `src/adapters/outbound/execution/detached-codex-generator.ts`, `src/adapters/outbound/persistence/t-note-store.ts` | ST-011-07 | PASS: safe replacement smoke, packet redaction/provenance/no-tools |
...
| [ST-011-11](../.www/planning/artifacts/ST-011-11.md) | human-gated Markdown promotion | `src/core/domain/work/canonical-document.ts`, `src/core/application/work/canonical-promotion.ts`, `src/adapters/outbound/persistence/canonical-document-store.ts` | ST-011-09, ST-011-10 | PASS: digest/stale/approval/path allowlist/atomic write/no-Git-side-effect |
| [ST-011-12](../.www/planning/artifacts/ST-011-12.md) | Claude Opus·Gemini read-only review | `src/core/domain/review/review.ts`, `src/core/application/review/review-service.ts`, `src/adapters/outbound/review/review-adapters.ts` | ST-011-07, ST-011-11 | PASS: deny-by-default redaction, exact-digest approval, no-tool request, provenance |
