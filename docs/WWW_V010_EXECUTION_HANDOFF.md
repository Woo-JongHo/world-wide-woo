...
| --- | --- | --- | --- | --- |
| [ST-011-06](../.www/planning/artifacts/ST-011-06.md) | App Server native vertical slice | `src/system/adapters/executors/codex-app-server.ts`, `src/system/contracts/ports/executor-port.ts` | lifecycle probe | PASS: adapter + 실제 approval/cancel/resume probe |
| [ST-011-07](../.www/planning/artifacts/ST-011-07.md) | append-only `ProjectActivity` | `src/system/contracts/project-activity.ts`, `src/system/adapters/activity-journal-store.ts` | ST-011-06 | PASS: append/replay/corruption/sequence test |
| [ST-011-08](../.www/planning/artifacts/ST-011-08.md) | Chat·T-notes·Todo 3-pane Workbench | `src/system/services/project-workbench.ts`, `src/tui/` | ST-011-06, ST-011-07 | PASS: contract/layout + 실제 PTY stream/resume |
| [ST-011-09](../.www/planning/artifacts/ST-011-09.md) | source-linked packet-only T-note draft | `src/system/services/t-note-service.ts`, `src/system/adapters/detached-codex-generator.ts`, `src/system/adapters/t-note-store.ts` | ST-011-07 | PASS: safe replacement smoke, packet redaction/provenance/no-tools |
...
| [ST-011-11](../.www/planning/artifacts/ST-011-11.md) | human-gated Markdown promotion | `src/system/contracts/canonical-document.ts`, `src/system/services/canonical-promotion.ts`, `src/system/adapters/canonical-document-store.ts` | ST-011-09, ST-011-10 | PASS: digest/stale/approval/path allowlist/atomic write/no-Git-side-effect |
| [ST-011-12](../.www/planning/artifacts/ST-011-12.md) | Claude Opus·Gemini read-only review | `src/system/contracts/review.ts`, `src/system/services/review-service.ts`, `src/system/adapters/review-adapters.ts` | ST-011-07, ST-011-11 | PASS: deny-by-default redaction, exact-digest approval, no-tool request, provenance |
