...
| [ST-011-07](../.www/planning/artifacts/ST-011-07.md) | append-only `ProjectActivity` | `src/core/domain/project-activity.ts`, `src/adapters/outbound/activity-journal-store.ts` | ST-011-06 | PASS: append/replay/corruption/sequence test |
| [ST-011-08](../.www/planning/artifacts/ST-011-08.md) | Chat·T-notes·Todo 3-pane Workbench | `src/core/application/project-workbench.ts`, `src/adapters/inbound/tui/` | ST-011-06, ST-011-07 | PASS: contract/layout + 실제 PTY stream/resume |
| [ST-011-09](../.www/planning/artifacts/ST-011-09.md) | source-linked packet-only T-note draft | `src/core/application/t-note-service.ts`, `src/adapters/outbound/detached-codex-generator.ts`, `src/adapters/outbound/t-note-store.ts` | ST-011-07 | PASS: safe replacement smoke, packet redaction/provenance/no-tools |
...
| [ST-011-11](../.www/planning/artifacts/ST-011-11.md) | human-gated Markdown promotion | `src/core/domain/canonical-document.ts`, `src/core/application/canonical-promotion.ts`, `src/adapters/outbound/canonical-document-store.ts` | ST-011-09, ST-011-10 | PASS: digest/stale/approval/path allowlist/atomic write/no-Git-side-effect |
| [ST-011-12](../.www/planning/artifacts/ST-011-12.md) | Claude Opus·Gemini read-only review | `src/core/domain/review.ts`, `src/core/application/review-service.ts`, `src/adapters/outbound/review-adapters.ts` | ST-011-07, ST-011-11 | PASS: deny-by-default redaction, exact-digest approval, no-tool request, provenance |
