...
| --- | --- | --- | --- | --- |
| [ST-011-06](../.www/planning/artifacts/ST-011-06.md) | App Server native vertical slice | `src/adapters/outbound/codex-app-server.ts`, `src/core/application/native-harness.ts` | lifecycle probe | PASS: adapter + 실제 approval/cancel/resume probe |
| [ST-011-07](../.www/planning/artifacts/ST-011-07.md) | append-only `ProjectActivity` | `src/core/domain/execution/project-activity.ts`, `src/adapters/outbound/activity-journal-store.ts` | ST-011-06 | PASS: append/replay/corruption/sequence test |
...
| [ST-011-09](../.www/planning/artifacts/ST-011-09.md) | source-linked packet-only T-note draft | `src/core/application/work/t-note-service.ts`, `src/adapters/outbound/detached-codex-generator.ts`, `src/adapters/outbound/t-note-store.ts` | ST-011-07 | PASS: safe replacement smoke, packet redaction/provenance/no-tools |
