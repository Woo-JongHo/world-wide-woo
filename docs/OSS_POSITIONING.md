...
반면 프로젝트별 [workspace](../src/adapters/outbound/workspace/project-workspace.ts#L107), [Todo 저장](../src/adapters/outbound/persistence/todo-store.ts#L10), [Workbench projection](../src/adapters/inbound/tui/features/chat/workbench-views.ts), [Todo projection](../src/adapters/inbound/tui/features/dashboard/shared-dashboard-views.ts)은 WWW의 고유 방향과 일치한다.
