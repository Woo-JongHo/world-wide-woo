...
현재 WWW에는 자체 [`SessionRuntime`](../src/core/application/session-runtime.ts#L241)과 [`ModelRouter`](../src/adapters/outbound/model-router.ts#L51)가 있어 작은 agent harness의 책임까지 가진다. 이 방향을 확대하면 OMO와 차이가 줄어든다.
