...
| System / WOO-672 | src/core/application/orchestration/project-workbench.ts, src/adapters/outbound/executors/ | system/workbench, system/runtime |
| 관측 기록 | src/core/domain/execution/project-activity.ts, src/adapters/outbound/activity-journal-store.ts | system/journal |
