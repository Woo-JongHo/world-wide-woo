import { FileCredentialStore } from "../src/adapters/outbound/authentication/credential-store.js";
import { createModelRegistry } from "../src/adapters/outbound/authentication/model-router.js";
